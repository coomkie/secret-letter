        ...
        const usersData = [
            {
                ...
                gender: true,
                avatar: 'https://res.cloudinary.com/dshe78dng/image/upload/v1763969046/admin_default_avatar_igmdrv.webp',
            ...
            },
            {
                ...
                gender: true,
                avatar: 'https://res.cloudinary.com/dshe78dng/image/upload/v1764082592/user_male_default_avatar-removebg-preview_dhix5q.png',
                password: '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',
            },
            {
                email: 'nam@gmail.com',
            ...
            },
            {
                ...
                gender: false,
                avatar: 'https://res.cloudinary.com/dshe78dng/image/upload/v1764082592/user_female_default_avatar-removebg-preview_avvhz2.png',
                password: '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',
            },
        ];

        for (const u of usersData) {
            const userExists = await this._usersRepository.findOneBy({ email: u.email });
            if (!userExists) {
                // Create user
