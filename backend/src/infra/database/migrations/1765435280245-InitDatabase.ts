...
export class InitDatabase1765435280245 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."matches_status_enum" AS ENUM('open', 'on_going', 'closed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "matches" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "status" "public"."matches_status_enum" NOT NULL DEFAULT 'open', "senderId" uuid, "receiverId" uuid, CONSTRAINT "PK_8a22c7b2e0828988d51256117f4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."letters_mood_enum" AS ENUM('neutral', 'sad', 'happy', 'angry')`,
    );
    await queryRunner.query(
      `CREATE TABLE "letters" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "content" text NOT NULL, "mood" "public"."letters_mood_enum" NOT NULL DEFAULT 'neutral', "isSent" boolean NOT NULL DEFAULT false, "sendAt" TIMESTAMP WITH TIME ZONE NOT NULL, "isRead" boolean NOT NULL DEFAULT false, "isReply" boolean NOT NULL DEFAULT false, "userId" uuid, "matchId" uuid, CONSTRAINT "PK_bf70c41d26aa84cf2651d571889" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "matches" ADD CONSTRAINT "FK_28ae9f3b73c0c76cedb30fc784b" FOREIGN KEY ("senderId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "matches" ADD CONSTRAINT "FK_1855c4ddb88a2a81cfc3d1ea230" FOREIGN KEY ("receiverId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "letters" ADD CONSTRAINT "FK_6922f0999690f2206531a1bf6ee" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "letters" ADD CONSTRAINT "FK_65d4c5202bf482a63da69b0ce77" FOREIGN KEY ("matchId") REFERENCES "matches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reports" ADD CONSTRAINT "FK_d90c08db676eab7265e983bbe0e" FOREIGN KEY ("target_letter_id") REFERENCES "letters"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "reports" DROP CONSTRAINT "FK_d90c08db676eab7265e983bbe0e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reports" DROP CONSTRAINT "FK_9459b9bf907a3807ef7143d2ead"`,
    );
    await queryRunner.query(
      `ALTER TABLE "letters" DROP CONSTRAINT "FK_65d4c5202bf482a63da69b0ce77"`,
    );
    await queryRunner.query(
      `ALTER TABLE "letters" DROP CONSTRAINT "FK_6922f0999690f2206531a1bf6ee"`,
    );
    await queryRunner.query(
      `ALTER TABLE "matches" DROP CONSTRAINT "FK_1855c4ddb88a2a81cfc3d1ea230"`,
    );
    await queryRunner.query(
      `ALTER TABLE "matches" DROP CONSTRAINT "FK_28ae9f3b73c0c76cedb30fc784b"`,
    );
